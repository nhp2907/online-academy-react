...
import InstructorInputComponent from "./component/user-input/InstructorInputComponent";
...
const InstructorManagementComponent: React.FC<Props> = ({}) => {
    ...
    const loadData = async () => {
        const _users = await userService.findInstructorApi();
...
export default InstructorManagementComponent;